    ...
    <section class="content">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Edit Penilaian PLP II</h3>
                    ...
                    <table class="table table-bordered table-sm mb-4">
                        <tbody>
                                    ...
                                    <td style="width: 14%">
                                        <div class="form-n1">
                                            <input type="number" class="form-control n1 form-control-sm"
                                                ...
                                                value="{{ $indikator_n1->PnRkapIndikator->jumlah_nilai_rkap }}" required>
                                            <input type="hidden" name="id_rkap_indikator_n1[]" id="id_rkap_indikator_n1"
                                                value="{{ $indikator_n1->PnRkapIndikator->id_pn_rkap_indikator }}">
                                            <span class="text-danger">
                                                <small>*note: nilai max:{{ $indikator_n1->jumlah_nilai }}</small>
                                            </span>
                                            {{-- <input type="text" name="id_indikator_n1[]"
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="hidden" name="id_rkap_aspek_n1"
                                        value="{{ $rkap_aspek_n1->id_rkap_aspek }}">
                                    <input type="number" class="form-control form-control-sm" id="jml_nilai_n1"
                                        name="jml_nilai_n1" value="{{ $rkap_aspek_n1->jumlah_nilai }}" readonly>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                                    ...
                                    <td style="width: 14%">
                                        <div class="form-n2">
                                            <input type="number" class="form-control n2 form-control-sm"
                                                ...
                                                value="{{ $indikator_n2->PnRkapIndikator->jumlah_nilai_rkap }}" required>
                                            <input type="hidden" name="id_rkap_indikator_n2[]"
                                                value="{{ $indikator_n2->PnRkapIndikator->id_pn_rkap_indikator }}">
                                            <span class="text-danger">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="id_rkap_aspek_n2"
                                        value="{{ $rkap_aspek_n2->id_rkap_aspek }}">
                                    <input type="text" class="form-control form-control-sm" name="jml_nilai_n2"
                                        id="jml_nilai_n2" value="{{ $rkap_aspek_n2->jumlah_nilai }}" readonly>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                                    ...
                                    <td style="width: 14%">
                                        <div class="form-n3">
                                            <input type="number" class="form-control n3 form-control-sm"
                                                ...
                                                value="{{ $indikator_n3->PnRkapIndikator->jumlah_nilai_rkap }}" required>
                                            <input type="hidden" name="id_rkap_indikator_n3[]"
                                                value="{{ $indikator_n3->PnRkapIndikator->id_pn_rkap_indikator }}">
                                            <span class="text-danger">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="id_rkap_aspek_n3"
                                        value="{{ $rkap_aspek_n3->id_rkap_aspek }}">
                                    <input type="text" class="form-control form-control-sm" name="jml_nilai_n3"
                                        id="jml_nilai_n3" value="{{ $rkap_aspek_n3->jumlah_nilai }}" readonly>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                                    ...
                                    <td style="width: 14%">
                                        <div class="form-n4">
                                            <input type="number" class="form-control n4 form-control-sm"
                                                ...
                                                value="{{ $indikator_n4->PnRkapIndikator->jumlah_nilai_rkap }}" required>
                                            <input type="hidden" name="id_rkap_indikator_n4[]"
                                                value="{{ $indikator_n4->PnRkapIndikator->id_pn_rkap_indikator }}">
                                            <span class="text-danger">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="id_rkap_aspek_n4"
                                        value="{{ $rkap_aspek_n4->id_rkap_aspek }}">
                                    <input type="number" class="form-control form-control-sm" id="jml_nilai_n4"
                                        name="jml_nilai_n4" value="{{ $rkap_aspek_n4->jumlah_nilai }}" readonly>
                                </td>
                            </tr>
                        </tbody>
                    </table>
